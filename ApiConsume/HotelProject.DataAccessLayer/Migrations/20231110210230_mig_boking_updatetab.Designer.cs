...
namespace HotelProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20231110210230_mig_boking_updatetab")]
    partial class mig_boking_updatetab
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.AppUser", b =>
                {
                    ...
                    b.Property<string>("WokDapartment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    ...
                    b.Property<int>("MessageCatagoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.MessageCatagory", b =>
                {
                    b.Property<int>("MessageCatagoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MessageCatagoryId"), 1L, 1);

                    b.Property<string>("MessageCatagoryName")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MessageCatagoryId");

                    b.ToTable("MessageCatagories");
                });
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concrete.MessageCatagory", "MessageCatagory")
                        .WithMany("Contacts")
                        .HasForeignKey("MessageCatagoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MessageCatagory");
                });
